...
AddEventHandler("RS_AutoEvents_StopEvent", function(data, zone)
    ...
    ShowAdvancedNotification("RESELLER", "~r~EVENT ILLEGAL", "Terminé! Tu n'étais pas encore arrivé? Rien à foutre vient plus rapidement la prochaine fois!", "CHAR_LESTER_DEATHWISH",9)
    EventStop = true
    removeBlips()
end)
